           ...
           children:[
            ...
            },
            {
             ...
             component: r => require.ensure([], () => r(require('@/view/fund/fund-product/fund-product-detail-buy')), 'fund-product-detail-buy'),
						...
						{
							// 理财产品购买协议
							path: 'fund-product-detail-buy-agreement',
							name: 'fund-product-detail-buy-agreement',
							component: r => require.ensure([], () => r(require('@/view/fund/fund-product/fund-product-detail-buy/fund-product-detail-buy-agreement')), 'fund-product-detail-buy-agreement'),
						},
          ]
        }
      ]
			...
			{//协议
				path: 'setPayPwd-agreement',
				name: 'setPayPwd-agreement',
				component: r => require.ensure([], () => r(require('@/view/User/register/setPayPwd-agreement')), 'setPayPwd-agreement')
			}]
...
//			name:'profile',
			...
			{//常见问题
				path:'question',
				name:'question',
				component: r => require.ensure([], () => r(require('@/view/profile/OurHelpSettings/question')), 'question')
			},
			{//关于我们
				path:'about-us',
				name:'about-us',
